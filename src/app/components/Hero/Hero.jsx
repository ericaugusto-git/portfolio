...
<span className="animate-pulse text-[#4CE470]">generateBuzzwords(), index = 0;</span>
      ...
      <div className="text-nowrap font-thin uppercase text-lg font-martian text-comment-grey lg:text-sm xs:text-xs w-full">
      <span style={{textOrientation: 'upright', writingMode: 'vertical-rl'}} ref={latin}   onMouseOver={replayLatin} onFocus={replayLatin}  className="fixed left-3  xl:-left-2  bottom-5 "></span>
      <span style={{textOrientation: 'upright', writingMode: 'vertical-rl'}} ref={jp}  onMouseOver={replayJp} onFocus={replayJp}  className="fixed right-3 xs:-right-2 lg:-right-1   top-14 tracking-[0.4rem]"></span>
      </div>
