...
export default function Projects() {
    ...
    const projects = [
        {name: 'kashi-os', isOnline: true, link: 'https://ericaugusto-os.pages.dev', img: '/images/kashi-os.png', gif: '/images/kashi-os.gif', description: t('os'), skills: ['react', 'ts', 'scss', 'figma']},
